...
{\fontsize{12.5pt}{15pt}\selectfont \sffamily May 2016                                          % Subtitle
\\
...
One of the drifters stopped sending, and was replaced by a working unit at approximately 18:00LT. The drifters continued further east towards the small island Tofteholmen lying on a south-north threshold. At 22:00LT the drifters turned westwards. The speed of the drifters increased as they approched the outlet of the Drammensfjord. % This is in accordance with the simulated current fields (Figure~\ref{fig:Current3}). 
...
September 21st 2015. The point D1 represent the river water and the point B1
represent marine water with algae.}
\label{fig:brei1}
\end{figure}
...
The point D2 represent the river water and the point B2
represent marine water with algae.}
\label{fig:brei2}
\end{figure}
...
September 22nd 2015. The point S1 and S2 represent the freshest water 
...
At the first occation the river water from the Drammen river is concentrated on the 
...
This can be seen by studying the salinity at 6 m depth, that has a minimum value in the 
...
This discrepancy could be due to wrong timing, and that the freshest 
water could be found at the east side of the transect, also in the model, 
at a different time.
Figure 27 and 28 show that a strong current is flowing from Drammensfjorden
...
But at Sep 22 13:00, the current pattern are more irregular (see Figure 29). 
