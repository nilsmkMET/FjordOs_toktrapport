...
At the time of deployment the currents were weak due to high water (Fig.~\ref{fig:Current2}). The drifters stayed in approximately the same positions during ebb tide. At low water, 19:00LT the drifters started to drift northwards and continued for the next 12 hours. The drifters had a maximum speed of 0.5 m/s.% Similar speeds is not found in the simulated current fields (Fig.~\ref{fig:Current2}-\ref{fig:Current3}). 
...
The present research and development is mostly funded by the the regional research funds Oslofjordfondet. We gratefully acknowledge the support. Lars Petter R\o ed at MET has contributed with valuable discussions of both planning of the cruise and post processing of data. The authors would also like to thank the crew at the research vessel R/V Trygve Braarud. 
